...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (RegistroHuesped.txtNombre.getText().isBlank()) {
					throw new RuntimeException("LLena la casilla de nombre");
				}
				if (RegistroHuesped.txtApellido.getText().isBlank()) {
					throw new RuntimeException("LLena la casilla de apellidos");
				}
				if (RegistroHuesped.txtTelefono.getText().isBlank()) {
					throw new RuntimeException("LLena la casilla de telefono");
				}
				if (RegistroHuesped.txtFechaN.getDate() == null) {
					throw new RuntimeException("Coloca una fecha valida");
				}
				if (RegistroHuesped.txtNreserva.getText().isBlank()) {
					throw new RuntimeException("Llena la casilla de Numero de reserva");
				}

				var huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(),
						new BigInteger(txtTelefono.getText()), Integer.parseInt(txtNreserva.getText()));
